...
- Get your [Necessary Variables](https://github.com/NhoetKyaiteKaungLayy/FlashGroupRobot/blob/master/FlashGroupRobot/config.py)
...
`git clone https://github.com/NhoetKyaiteKaungLayy/FlashGroupRobot && cd FallenRobot`
